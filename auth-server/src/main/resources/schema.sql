...
CREATE TABLE IF NOT EXISTS AUTH_SCHEMA.ROLE (
	...
	CONSTRAINT ROLE_APP_FK FOREIGN KEY (APP_ID) REFERENCES AUTH_SCHEMA.APPLICATION (ID)
);
...
CREATE TABLE IF NOT EXISTS AUTH_SCHEMA.ACCESS (
	...
	CONSTRAINT ACCESS_DAD_FK FOREIGN KEY (PRIVILEGE_ID) REFERENCES AUTH_SCHEMA.PRIVILEGE (ID),
...
CREATE SEQUENCE IF NOT EXISTS AUTH_SCHEMA.ACCESS;
